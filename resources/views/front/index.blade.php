		...
		<div class="row">
			...
			<div class="col-lg-4 col-md-6 col-sm-12 wow {{ $fade_val }}">
				<div class="listing-item effect-item">
					<div class="photo image-effect">
						<a href="{{ route('front_listing_detail',[$row->id,$row->listing_slug]) }}"><img src="{{ asset('uploads/listing_featured_photos/'.$row->listing_featured_photo) }}" alt=""></a>
						<div class="brand">
					...
					<div class="text">
						...
						<h3><a href="{{ route('front_listing_detail',[$row->id,$row->listing_slug]) }}">{{ $row->listing_name }}</a></h3>
						<div class="location">
